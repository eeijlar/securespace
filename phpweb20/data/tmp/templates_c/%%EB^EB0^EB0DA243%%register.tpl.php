<?php /* Smarty version 2.6.18, created on 2010-04-30 13:26:55
         compiled from account/register.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'account/register.tpl', 6, false),)), $this); ?>
 ...
 ?>
             ...
             <legend><b>Mobile Number</b></legend>
                     <div id="mobileTable">
                        ...
                        <label style="margin-left: 200px">Area Code</label>
                        <label style="margin-left: 25px">Local Number</label>
                     </div>
                     <div style="clear: both;">
                         <div style="float: left; padding-top:5px;"><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'account/lib/countries.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></div>
                         <div style="float: left;"><input type="hidden" name="countryCode" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['fp']->countryCode)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"/></div>
                         <div style="float: left;"><input type="text" id="area_code_container" name="area_code" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['fp']->area_code)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" maxlength="7" size="12"
                                   onclick="checkAddressMatch(this.form.email.value,this.form.verify_email.value)"/></div>
                         <div style="float: left;"><input type="text" id="local_number_container" name="local_number" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['fp']->local_number)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" maxlength="9" size="13"
		...
		<div>					
			...
			<div style="float:right; margin-left:70px">
				...
				<input type="radio" name="tandc_radio" value="No" checked="checked"/> No
           		...
           		<input type="hidden" name="tandc" value="yes"/> <?php $_smarty_tpl_vars = $this->_tpl_vars;
        ...
        <legend><b>Therapist</b></legend>
		     ...
		     <?php if ($this->_tpl_vars['sme']): ?>
	 	     ...
	 	     <?php else: ?>
                ...
                <div><input type="hidden" name="sme" value="yes"/> <?php $_smarty_tpl_vars = $this->_tpl_vars;

<?php /* Smarty version 2.6.18, created on 2009-10-06 12:35:50
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'account/register_header.tpl', 'smarty_include_vars' => array()));
...
unset($_smarty_tpl_vars);
 ?>                                        
			...
			<div>&nbsp;</div>
			<textarea onclick="this.form.mobile.value=updateMobileNumber(this.form.countryCode.value,this.form.area_code.value,this.form.local_number.value);" class="textarea" name="smeprofile" cols="65"
			rows="10"></textarea>
				<?php $_smarty_tpl_vars = $this->_tpl_vars;

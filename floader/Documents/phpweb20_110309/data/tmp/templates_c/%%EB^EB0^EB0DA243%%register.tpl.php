...
<!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->
		<div class="row inline">
			<label for="form_country">Country Code</label>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
<!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->		
		...
		<input type="text" id="area_code_container" name="area_code" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['fp']->area_code)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>" maxlength="7" size="12"
	    onclick="checkAddressMatch(this.form.email.value,this.form.verify_email.value)"/>

		</div>
<!-- xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->		
	     <div class="row inline">
			<label for="form_country">Local Number</label>	
		<input type="text" id="local_number_container" name="local_number" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['fp']->local_number)) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>" maxlength="9" size="13"

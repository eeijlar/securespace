...
<form method="post" action="/account/login">
    <fieldset>
        <legend><b>Login To Your Secure Counselling Account</b></legend>              
        ...
        <div>
			...
			<img src="/images/padlock_sml.png" alt="padlock" align="absmiddle" width="20" height="25">
        </div>
		<div>&nbsp;</div>		
		<div><p>Please note that you will not be able to log in until your application has been reviewed by one of our therapists. You will receive a text message when your application has been processed</p>
    </fieldset>
</form>

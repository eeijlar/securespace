...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'mail/lib/messages.tpl', 'smarty_include_vars' => array('messages' => $this->_tpl_vars['newMessages'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
